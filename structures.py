...
class CaseInsensitiveDict(collections.MutableMapping):
    ...
    All keys are expected to be strings. The structure remembers the case
    of the last key to be set, and "iter(instance)", "keys()", "items()",
    "iterkeys()", and "iteritems()" will contain case-sensitive keys.
    However, querying is case insensitive.
    """
...
class WSGIHeaderDict(CaseInsensitiveDict):
    """WSGI header dict."""
